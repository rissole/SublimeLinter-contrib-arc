...
Once you have installed and configured `arc`, you can proceed to install the SublimeLinter-contrib-arc plugin if it is not yet installed.
...
1. When the plugin list appears, type `arc`. Among the entries you should see `SublimeLinter-contrib-arc`. If that entry is not highlighted, use the keyboard or mouse to select it.
